...
> Historical note: this document describes the older challenge-window / pending-commit design track, not the current canonical root in [`../src/lib.rs`](../src/lib.rs).
